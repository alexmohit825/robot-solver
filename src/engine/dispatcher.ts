...
export function generateClinicalEmail(
  ...
  const subject = `[OR Block Notice] Dr. ${profile.name} - Protected Window (${formattedTimeWindow})`;
...
Surgeon: Dr. ${profile.name}, ${profile.title} (${profile.specialty})
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Dr. ${profile.name}, ${profile.title} • ${profile.specialty}</p>
    </div>
    <div class="content">
    ...
    <div class="footer">
      Dr. ${profile.name} Office Contact: <a href="mailto:${profile.officeEmail}">${profile.officeEmail}</a><br>
